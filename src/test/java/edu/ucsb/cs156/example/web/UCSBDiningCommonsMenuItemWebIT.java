...
public class UCSBDiningCommonsMenuItemWebIT extends WebTestCase {
  ...
  public void admin_user_can_create_edit_delete_menu_item() throws Exception {
    ...
    page.getByTestId("UCSBDiningCommonsMenuItemForm-dining_commons_code").fill("ortega");
    page.getByTestId("UCSBDiningCommonsMenuItemForm-name").fill("Mac-n-Cheese");
    page.getByTestId("UCSBDiningCommonsMenuItemForm-station").fill("Blue Plate");
